...
export function OnboardingPageContent() {
  ...
  return (
    <div className="bg-surface text-on-surface font-sans selection:bg-primary/30 min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <Link href="/" className="fixed top-6 left-8 flex items-center gap-2 group">
          ...
          <div className="p-8 pt-4">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-6 mt-2">
                <Button
                  className="text-xs text-slate-500 hover:text-slate-300 flex items-center gap-1.5 transition-colors font-bold uppercase tracking-widest"
                  variant="ghost"
