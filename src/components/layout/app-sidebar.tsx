  ...
  return (
    <Sidebar className="bg-surface border-none shadow-[40px_0_80px_-20px_rgba(6,14,32,0.5)]">
                  ...
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton
                      ...
                      className={cn(
                        ...
                        isActive
                          ? 'brand-text bg-linear-to-r from-[color:var(--brand)]/10 to-transparent border-r-2 border-[color:var(--brand)]'
      ...
      <SidebarFooter className="p-4 mt-auto border-t border-white/5 space-y-2">
        ...
        {isConnected
          ? (
              <Button className="w-full h-11 bg-primary-container/10 border border-primary/20 text-primary hover:bg-primary-container/16 rounded-sm text-sm tracking-normal transition-all" onClick={() => open()}>
                Vault Active
              </Button>
            )
          : (
              <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogTrigger
                  render={(
                    <Button className="w-full h-11 bg-primary-container/10 border border-primary/20 text-primary hover:bg-primary-container/16 rounded-sm text-sm tracking-normal transition-all">
                      Connect Wallet
                    </Button>
                  )}
                />
        ...
        <button className="flex items-center gap-3 w-full px-4 py-2.5 text-destructive/80 hover:text-destructive transition-colors font-semibold text-sm mt-1 rounded-sm">
