              ...
              <CardContent className="relative flex h-full flex-col justify-between p-8">
                <div className="relative z-10">
                  ...
                  <div className="flex gap-4">
                    <Button className="primary-gradient flex-1 text-on-primary-container h-12 rounded-sm text-sm flex items-center justify-center gap-2 hover:brightness-110 active:scale-95 transition-all border-none shadow-lg shadow-primary/20">
                      <AddCircleIcon className="size-5" />
                      Deposit
                    </Button>
                    <Button variant="outline" className="flex-1 border-white/10 hover:bg-surface-container h-12 rounded-sm text-sm flex items-center justify-center gap-2 active:scale-95 transition-all">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="bg-surface-container-low p-6 rounded-xl border border-white/5 flex flex-col justify-center shadow-inner">
                    ...
                    <div className="flex gap-2">
                      <Button variant="outline" size="sm" className="h-10 flex-1 rounded-lg text-[10px] font-black uppercase tracking-widest text-white hover:bg-surface-bright">
                        +1m
                      </Button>
                      <Button variant="outline" size="sm" className="h-10 flex-1 rounded-lg text-[10px] font-black uppercase tracking-widest text-white hover:bg-surface-bright">
                        +3m
                      </Button>
                      <Button variant="tertiary" size="sm" className="h-10 flex-1 rounded-lg text-[10px] font-black uppercase tracking-widest">
                        Custom
                      </Button>
                    </div>
                  </div>
          ...
          <CardContent className="px-0">
            <div className="px-8 py-6 border-b border-white/5 flex justify-between items-center bg-surface-container-high/30">
              ...
              <div className="flex items-center gap-6">
                <Button variant="ghost" size="sm" className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant hover:text-white">
            ...
            <Table className="text-left">
              <TableHeader className="bg-surface-container-low">
                <TableRow className="border-white/5 hover:bg-transparent">
                  ...
                  <TableHead className="px-8 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant">Encrypted Amount</TableHead>
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={tx.hash} className="group cursor-pointer border-white/5 hover:bg-surface-container-high/40">
            ...
            <div className="p-6 text-center border-t border-white/5 bg-surface-container-lowest/10">
              <Button variant="ghost" className="text-[10px] font-black uppercase tracking-[0.2em] text-primary hover:text-white">Load More Transactions</Button>
            </div>
          </CardContent>
        </Card>
      </div>
