      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8">
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] border-b border-white/5">
                      <th className="px-6 py-4 font-black">Employee Identity</th>
                    ...
                    {[
                      ...
                      <tr key={row.id} className="hover:bg-surface-container transition-colors group cursor-pointer">
                        ...
                        <td className="px-6 py-5 text-right">
                          {row.active
                            ? (
                                <Button size="sm" className="bg-primary-container text-on-primary-container h-8 px-4 rounded-lg font-black text-[10px] uppercase tracking-widest hover:opacity-90 border-none">Set Budget</Button>
                              )
                            : (
                                <button className="text-[10px] font-black uppercase tracking-[0.2em] text-outline hover:text-on-surface transition-colors">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Set Budget Card */}
            <div className="bg-surface-container p-6 rounded-xl border border-primary/30 shadow-[0_0_40px_rgba(99,102,241,0.15)] relative overflow-hidden group">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className="w-full bg-surface-container-lowest border-none focus:ring-1 focus:ring-tertiary/40 rounded-lg px-10 py-4 text-on-surface font-mono font-bold outline-none shadow-inner"
                      placeholder="••••••••"
                      type="text"
                    />
                ...
                <Button className="w-full primary-gradient text-on-primary-fixed h-14 rounded-xl font-heading font-black text-sm tracking-widest shadow-xl shadow-primary/20 active:scale-[0.98] transition-all border-none">
            ...
            {/* Protocol Status */}
            <div className="bg-surface-container-low p-6 rounded-xl border border-white/5 space-y-5 shadow-xl">
            ...
            <div className="bg-surface-container-low p-6 rounded-xl border border-white/5 overflow-hidden relative shadow-xl">
